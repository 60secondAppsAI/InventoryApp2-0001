...
const isDeploymentServersPage = computed(() => route.name === 'deployment-servers');
	const isInventorysPage = computed(() => route.name === 'inventorys');
				
const navigateToSignIn = () => {
  router.push({ name: 'signin' });
};

	const navigateToInventorys = () => {
  router.push({ name: 'inventorys' });
};
    ...
    <div class="header-container">
      ...
      <div class="actions-section">
        <template v-if="isAuthenticated">
	          ...
	          <button @click="navigateToInventorys" class="btn-secondary"
            :class="{ active: isInventorysPage }"
          >
            Inventorys
          </button>
